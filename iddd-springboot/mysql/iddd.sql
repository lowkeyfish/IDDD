...
SET @brandId = REPLACE(UUID(), '-', '');
INSERT INTO `brand`(`uid`,`name`,`first_letter`,`logo`) VALUES
    (@brandId, '奥迪','A','/images/brand/audi.png');

SET @manufacturerId = REPLACE(UUID(), '-', '');
INSERT INTO `manufacturer`(`uid`,`name`,`brand_id`) VALUES
    (@manufacturerId,'上汽奥迪',@brandId);

SET @modelId = REPLACE(UUID(), '-', '');
INSERT INTO `model`(`uid`,`name`,`brand_id`,`manufacturer_id`,`image`,`price_min`,`price_max`) VALUES
    (@modelId,'奥迪Q5 e-tron',@brandId,@manufacturerId,'/images/model/q5e-tron.png',298500,435500);

SET @variantId = REPLACE(UUID(), '-', '');
INSERT INTO `variant`(`uid`,`name`,`price`,`brand_id`,`manufacturer_id`,`model_id`) VALUES
