...
public enum PaymentStatusType implements ValueDescriptionEnum<Integer> {
    ...
    PaymentStatusType(int value, String description) {
        this.value = value;
    ...
    public static PaymentStatusType parse(Object value) {
        return EnumUtilsEnhance.getByIntValueOrStringName(value, PaymentStatusType.class);
    }
}
