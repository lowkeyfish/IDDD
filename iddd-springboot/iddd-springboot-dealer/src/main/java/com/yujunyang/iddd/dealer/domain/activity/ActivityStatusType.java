...
public enum ActivityStatusType implements ValueDescriptionEnum<Integer> {
    ...
    ActivityStatusType(int value, String description) {
        this.value = value;
    ...
    public static ActivityStatusType parse(Object value) {
        return EnumUtilsEnhance.getByIntValueOrStringName(value, ActivityStatusType.class);
    }
}
