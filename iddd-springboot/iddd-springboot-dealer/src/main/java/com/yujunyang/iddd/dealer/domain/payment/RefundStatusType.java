...
public enum RefundStatusType implements ValueDescriptionEnum<Integer> {
    ...
    RefundStatusType(int value, String description) {
        this.value = value;
    ...
    public static RefundStatusType parse(Object value) {
        return EnumUtilsEnhance.getByIntValueOrStringName(value, RefundStatusType.class);
    }
}
