...
public enum SmsSendStatus implements ValueDescriptionEnum<Integer> {
    UNSENT(1, "未发送"),
    SENT(2, "已发送");
    ...
    public static SmsSendStatus parse(Integer value) {
        return EnumUtilsEnhance.getByValue(value, SmsSendStatus.class);
    }
}
